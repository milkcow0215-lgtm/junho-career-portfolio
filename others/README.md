...
│
├── job_crawler/                        # 🔍 Gmail API 기반 채용 공고 실시간 모니터링 및 알림 파이프라인
│   └── README.md
│
└── quant_trading/                      # 📈 WebSocket 기반 글로벌 자산 스크리닝 및 자동 매매 시스템
    └── README.md
```
