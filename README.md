...
### 1. 🤖 투명 사출물 결함 검수 및 로봇 자동화 공정 시스템 ([01_gear_assembly_robot_arm](./ROKEY_Work/01_gear_assembly_robot_arm/))
...
### 2. 🚜 SLAM 기반 건설현장 유도원 자동화 시스템 - 오라이봇 ([02_construction_truck_guidance](./ROKEY_Work/02_construction_truck_guidance/))
...
### 4. 📈 글로벌 자산 스크리닝 자동 매매 및 Gmail 취업 모니터링 파이프라인 ([03_others](./ROKEY_Work/03_others/))
